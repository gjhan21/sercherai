...
const quickLinks = computed(() =>
  [
    ...
    { title: "数据治理", desc: "查看供应商能力、路由策略与默认治理配置", path: "/data-sources/governance", permission: "data_source.view" },
    { title: "数据同步", desc: "执行股票、期货、资讯与仓单同步任务", path: "/data-sources/sync", permission: "data_source.view" },
    { title: "数据质量", desc: "排查质量日志、问题分布与 payload 详情", path: "/data-sources/quality", permission: "data_source.view" },
    { title: "数据源管理", desc: "查看健康状态、默认源与数据源日志", path: "/data-sources/registry", permission: "data_source.view" },

...
func NewAdminCommunityHandler(base *AdminBaseHandler) *AdminCommunityHandler {
	return &AdminCommunityHandler{AdminBaseHandler: *base}
}

func (h *AdminCommunityHandler) ListCommunityTopics(c *gin.Context) {
...
func (h *AdminCommunityHandler) UpdateCommunityTopicStatus(c *gin.Context) {
	id := c.Param("id")
...
func (h *AdminCommunityHandler) ListCommunityComments(c *gin.Context) {
	page, pageSize := parsePage(c)
...
func (h *AdminCommunityHandler) UpdateCommunityCommentStatus(c *gin.Context) {
	id := c.Param("id")
	var req dto.CommunityStatusUpdateRequest
	if err := c.ShouldBindJSON(&req); err != nil {
		c.JSON(http.StatusBadRequest, dto.APIResponse{Code: 40001, Message: err.Error(), Data: struct{}{}})
...
func (h *AdminCommunityHandler) ListCommunityReports(c *gin.Context) {
	page, pageSize := parsePage(c)
...
func (h *AdminCommunityHandler) ReviewCommunityReport(c *gin.Context) {
	id := c.Param("id")
